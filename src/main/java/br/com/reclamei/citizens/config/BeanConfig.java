...
public class BeanConfig {
    ...
    private static final List<String> ENTITIES_FILTER = List.of("Domain", "Type", "Dto", "Request", "Response", "Builder", "Exception", "Utils",
    ...
    void genericApplicationContext(BeanDefinitionRegistry beanRegistry) {
        ...
        beanDefinitionScanner.scan("br.com.reclamei.citizens.dataprovider", "br.com.reclamei.citizens.core");
    }
